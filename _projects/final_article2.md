---
layout: distill
title: 'Part 2: Analyzing The Results'
description: "This is Part 2 in the series, where we explore how the fastai deep learning  library can be used to conduct structured empirical experiments on a novel and small dataset. The dataset consists of 850 images and an almost uniform distribution for the target labels. There are two labels in total, 'male' and 'female', that have assigned the gender of the model depicted in any of the images in the dataset."
...
and 'female', that have assigned the gender of the model depicted in any of the
...
setups (these have `fine_tune=1`) and, which to two epoch setups
(`fine_tune=2`). This can be found looking at the column `fine_tune`.
