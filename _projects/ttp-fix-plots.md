...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/p.png" title="Overview" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
```python
ax, fig = plt.subplots(1, 1, figsize=(22, 14))
ax = plt.subplot(111)
...
```python
def plot_fi(fi):
    return fi.plot("cols", "imp", "barh", figsize=(12, 8), legend=False,title='Feature Importance Plot',ylabel='Feature',xlabel='Feature Importance Score')
```
...
```
    ...
    <matplotlib.collections.PathCollection at 0x16dcc9f30>
...
<style>
    ...
    <class 'numpy.ndarray'> 1459 (1459,)
    (1459,) [59773.48518382 62065.47726221 62115.10757965 65206.4640491 ]
           Id     SalePrice
    414  1875  74133.488121
    402  1863  68618.550827
    983  2444  61450.787267
