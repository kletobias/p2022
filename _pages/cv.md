...
<d-contents>
  ...
  <h3>Contents</h3>
    ...
    <div class="no-math"><a href="#bachelors-thesis">Bachelors Thesis</a></div>
    <div class="no-math"><a href="#list-of-portfolio-videos">List Of Portfolio Videos</a></div>
...
The methodology is in accordance with the esteemed Stanford University's
[Practical Machine Learning](https://c.d2l.ai/stanford-cs329p/) course. In the
context of structured data, it is essential to undertake a number of pivotal
...
- **Bachelor's Thesis:**
    ...
    - **Pages:** 69
    - **Grade:** 1.0
    - **Abstract:** See Section 'Bachelors Thesis'
...
| **Course**                                                                                   | **Grade** |
|----------------------------------------------------------------------------------------------|-----------|
| Bachelor's Thesis: Data Mining - Hyperparameter Optimization for Real Estate Prediction Models | 1.0       |
